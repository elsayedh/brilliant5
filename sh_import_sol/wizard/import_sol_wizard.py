                        ...
                        try:
                            ...
                            if row[0] != '':
                                ...
                                if search_product:
                                    ...
                                    vals.update(
                                            {'price_unit': search_product.lst_price})
                                    if row[4].strip() in (None, "") and search_product.taxes_id:
                                        vals.update(
                    ...
                    for row in range(sheet.nrows):
                        try:
                            ...
                            if sheet.cell(row, 0).value != '':
                                ...
                                print("sheet.cell(row, 0).value)", sheet.cell(row, 0).value)
                                ...
                                if search_product:
                                    ...
                                    if sheet.cell(row, 4).value.strip() in (None, "") and search_product.taxes_id:
                                        vals.update(
                                            {'tax_id': [(6, 0, search_product.taxes_id.ids)]})
                                    else:
                                        taxes_list = []
